...
{
    // clone of https://referencesource.microsoft.com/#system/services/io/system/io/PatternMatcher.cs
    internal static class PatternMatcher
    {
        ...
        ///
        /// </devdoc>
        public static bool Match(string name, string expression)
        {
            char nameChar = '\0';
            ...
            while (!nameFinished)
            {
                ...
                while (srcCount < matchesCount)
                {
                    ...
                    //  end with a break.
                    //
                    var exprOffset = ((previousMatches[srcCount++] + 1) / 2);
                    length     = 0;
                    ...
                    while (true)
                    {
                        ...
                        var exprChar = expression[exprOffset];
                        length   = 1;
