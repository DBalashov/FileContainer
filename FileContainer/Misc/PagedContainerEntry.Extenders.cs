...
namespace FileContainer
{
    static class PagedContainerEntryExtenders
    {
        ...
        [NotNull]
        internal static Dictionary<string, PagedContainerEntry> ReadEntries([NotNull] this byte[] buff, [NotNull] IDataHandler handler)
        {
        ...
        [NotNull]
        internal static byte[] WriteEntries([NotNull] this Dictionary<string, PagedContainerEntry> entries, [NotNull] IDataHandler handler)
        {
            ...
            bw.Flush();
            return handler.Pack(stm.ToArray());
        }
    }
}